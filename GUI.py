...
Caffe_net = cv.dnn.readNetFromCaffe("./colorization_deploy_v2.prototxt",
...
class Window(Frame):
    ...
    def upload_image(self):
        ...
        Caffe_net.getLayer(Caffe_net.getLayerId('conv8_313_rh')).blobs = [np.full([1,
                                                                                   313], 2.606, np.float32)]
        input_width = 224
        input_height = 224
